...
\begin{figure}[!htb]
    ...
    \caption{10 adrenal gland patients treated at the MR-Linac. Sparing factors dependent on distance $w$ grouped by OAR. Multiple OAR per patient were collected and not only the dose-limiting OAR.}
    \label{fig:0}
\end{figure}
...
\begin{figure}[!htb]
    ...
    \caption{10 adrenal gland patients treated at the MR-Linac. Sparing factors $\delta$ dependent on distance $w$ grouped by patient. Row shows dose-limiting OAR.}
...
\begin{figure}[!htb]
    ...
    \caption{10 adrenal gland patients treated at the MR-Linac. Sparing factors $\delta$ (shown as triangles) and distance $w$ shown (as lines) displayed for each fraction grouped by patient. Row shows OAR which is dose-limiting.}
...
\begin{figure}[!htb]
    ...
    \caption{10 pancreas patients treated at the MR-Linac. Sparing factors dependent on distance $w$ grouped by OAR. Multiple OAR per patient were collected and not only the dose-limiting OAR.}
...
\begin{figure}[!htb]
    ...
    \caption{10 pancreas patients treated at the MR-Linac. Sparing factors $\delta$ dependent on distance $w$ grouped by patient. Row shows dose-limiting OAR.}
...
\begin{figure}[!htb]
    ...
    \caption{10 pancreas patients treated at the MR-Linac. Sparing factors $\delta$ (shown as triangles) and distance $w$ (shown as lines) displayed for each fraction grouped by patient. Row shows OAR which is dose-limiting.}
...
\begin{figure}[!htb]
    ...
    \caption{10 prostate patients treated at the MR-Linac. Sparing factors dependent on distance $w$ grouped by target volume DIL (prostate boost volume) and PRO (prostate volume).}
...
\begin{figure}[!htb]
    ...
    \caption{10 prostate patients treated at the MR-Linac. Sparing factors $\delta$ dependent on distance $w$ grouped by target volume DIL (prostate boost volume) and PRO (prostate volume)}
...
\begin{figure}[!htb]
    ...
    \caption{10 prostate patients treated at the MR-Linac. Sparing factors for each patient grouped by target volume DIL (prostate boost volume) and PRO (prostate volume).}
...
\begin{figure}[!htb]
    ...
    \caption{10 prostate patients treated at the MR-Linac. Sparing factors $\delta$ (shown as triangles) and distance $w$ (shown as lines) displayed for each fraction grouped by target volume DIL (prostate boost volume) and PRO (prostate volume)}
