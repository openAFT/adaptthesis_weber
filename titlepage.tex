...
\begin{abstract}
	...
	Main Results: In one patient with pancreatic cancer reducing number of fractions with Adaptive Fractionation resulted in a BED$_3$ decrease of $16\%$ compared to Uniform Fractionation. The treatment reduced the number of fractions to $2$ number of fractions. In a second patient with pancreatic cancer, reducing number of fractions with Adaptive Fractionation led to no reduction in number of fractions but a BED$_3$ decrease of $13\%$ compared to Uniform Fractionation. In one patient with cancer in adrenal glands, reducing number of fractions with Adaptive Fractionation led to no reduction in number of fractions and a small BED$_3$ decrease of $0.5\%$ compared to Uniform Fractionation, due to an unfavourable planning sparing factor, that is used for estimating the mean of $\delta$.
